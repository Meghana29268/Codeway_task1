...
class TodoApp(QMainWindow):
    ...
    def create_actions(self):
        self.save_action = QAction(QIcon('C:/Users/My Pc/Desktop/To Do GUI Application/icons/save.png'), 'Save', self)
        self.save_action.triggered.connect(self.save_tasks)

        self.open_action = QAction(QIcon('C:/Users/My Pc/Desktop/To Do GUI Application/icons/open.png'), 'Open', self)
        self.open_action.triggered.connect(self.load_tasks)

        self.exit_action = QAction(QIcon('C:/Users/My Pc/Desktop/To Do GUI Application/icons/exit.png'), 'Exit', self)
